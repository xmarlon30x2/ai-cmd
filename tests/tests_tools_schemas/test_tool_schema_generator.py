...
from ai_cmd.schemas.tool_schema_generator import function_to_tool_schema
...
class TestToolSchemaGenerator(unittest.TestCase):
    ...
    def test_function_with_simple_arguments(self):
        ...
        self.assertEqual(schema["function"]["name"], "my_function")
        self.assertEqual(schema["function"]["description"], "My function")
        self.assertEqual(schema["function"]["parameters"]["properties"]["a"]["type"], "integer")
        self.assertEqual(schema["function"]["parameters"]["properties"]["b"]["type"], "string")
    ...
    def test_function_with_docstring_descriptions(self):
        ...
        self.assertEqual(schema["function"]["name"], "my_function")
        self.assertEqual(schema["function"]["description"], "My function")
        self.assertEqual(schema["function"]["parameters"]["properties"]["a"]["description"], "The first argument")
        self.assertEqual(schema["function"]["parameters"]["properties"]["b"]["description"], "The second argument")
        self.assertEqual(schema["function"]["parameters"]["required"], ["a", "b"])
    ...
    def test_function_with_list_argument(self):
        ...
        schema = function_to_tool_schema(my_function)
        self.assertEqual(schema["function"]["parameters"]["properties"]["a"]["type"], "array")
        self.assertEqual(schema["function"]["parameters"]["properties"]["a"]["items"]["type"], "integer")
    ...
    def test_function_with_optional_argument(self):
        ...
        schema = function_to_tool_schema(my_function)
        self.assertEqual(schema["function"]["parameters"]["properties"]["a"]["type"], "integer")
        self.assertTrue(schema["function"]["parameters"]["properties"]["a"]["nullable"])
    ...
    def test_function_with_enum_argument(self):
        ...
        self.assertEqual(schema["function"]["parameters"]["properties"]["a"]["enum"], ["value1", "value2"])
    ...
    def test_method_with_self_parameter(self):
        ...
        self.assertEqual(schema["function"]["name"], "my_method")
        self.assertEqual(schema["function"]["parameters"]["properties"], {})
        self.assertEqual(schema["function"]["parameters"]["required"], [])
    ...
    def test_function_with_nested_list_argument(self):
        ...
        schema = function_to_tool_schema(my_function)
        self.assertEqual(schema["function"]["parameters"]["properties"]["a"]["type"], "array")
        self.assertEqual(schema["function"]["parameters"]["properties"]["a"]["items"]["type"], "array")
        self.assertEqual(schema["function"]["parameters"]["properties"]["a"]["items"]["items"]["type"], "integer")
    ...
    def test_function_with_dict_list_argument(self):
        ...
        schema = function_to_tool_schema(my_function)
        self.assertEqual(schema["function"]["parameters"]["properties"]["a"]["type"], "object")
        self.assertEqual(schema["function"]["parameters"]["properties"]["a"]["additionalProperties"]["type"], "array")
        self.assertEqual(schema["function"]["parameters"]["properties"]["a"]["additionalProperties"]["items"]["type"], "integer")
    ...
    def test_function_with_union_argument(self):
        ...
        schema = function_to_tool_schema(my_function)
        self.assertEqual(len(schema["function"]["parameters"]["properties"]["a"]["oneOf"]), 2)
        self.assertEqual(schema["function"]["parameters"]["properties"]["a"]["oneOf"][0]["type"], "integer")
        self.assertEqual(schema["function"]["parameters"]["properties"]["a"]["oneOf"][1]["type"], "string")
    ...
    def test_function_with_unicode_docstring(self):
        ...
        schema = function_to_tool_schema(my_function)
        self.assertEqual(schema["function"]["description"], "My function with ünicode")
    ...
    def test_function_with_special_chars_docstring(self):
        ...
        schema = function_to_tool_schema(my_function)
        self.assertEqual(schema["function"]["description"], "My function with !@#$%^&*()")
